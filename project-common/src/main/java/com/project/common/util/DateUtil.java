...
public final class DateUtil {
    ...
    public static DateTimeFormatter PATTERN2 = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");
    public static DateTimeFormatter PATTERN3 = DateTimeFormatter.ofPattern("yyyy-MM-dd hh:mm:ss");
    public static DateTimeFormatter PATTERN4 = DateTimeFormatter.ofPattern("yyyy/MM/dd hh:mm:ss");
    public static DateTimeFormatter PATTERN5 = DateTimeFormatter.ofPattern("yyyy-MM-dd");
    public static DateTimeFormatter PATTERN6 = DateTimeFormatter.ofPattern("yyyy/MM/dd");
    public static DateTimeFormatter PATTERN7 = DateTimeFormatter.ofPattern("yyyyMMdd");
